...
class HomeArticleListItem extends StatefulWidget {
  ...
  const HomeArticleListItem({Key? key, required this.articleItem,}) : super(key: key);
...
class _HomeArticleListItemState extends State<HomeArticleListItem> {
  ...
  Widget build(BuildContext context) {
    ...
    var _convertedTimestamp = DateTime.parse(
        _timestamp!); // Converting into [DateTime] object
    var result = GetTimeAgo.parse(_convertedTimestamp);

    if (widget.articleItem!.images!.isNotEmpty) {
      imageUrl = "https://ndxv3.s3.ap-south-1.amazonaws.com/${widget.articleItem
          ?.images?[0].imageId}_100.jpg";
    } else {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        InkWell(
                          child: SvgPicture.asset("assets/bi_bookmark.svg"),
                          onTap: () {
