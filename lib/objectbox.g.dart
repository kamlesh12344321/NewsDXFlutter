...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 2267437578010687483),
      name: 'BookMarkArticleModel',
      lastPropertyId: const IdUid(2, 3855756003394213732),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 79733231553604546),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 3855756003394213732),
            name: 'articleId',
            type: 9,
            flags: 0)
      ],
  ...
  ModelEntity(
      id: const IdUid(2, 8258290512779985450),
      name: 'MyFeedModel',
      lastPropertyId: const IdUid(2, 7067050982433925391),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 7185932554755271003),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 7067050982433925391),
            name: 'sectionId',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(2, 8258290512779985450),
